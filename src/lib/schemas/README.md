...
### `slugParamSchema` y `idParamSchema`
...
- `PATCH /api/links/[id]` - Usa `updateShortLinkSchema` y `idParamSchema`
- `GET /api/links/[id]` - Usa `idParamSchema`
- `DELETE /api/links/[id]` - Usa `idParamSchema`
